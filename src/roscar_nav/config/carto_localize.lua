...
-- Localization: trim submaps to bound memory, but keep enough to avoid
-- instability. max_submaps_to_keep too low (3) triggered std::length_error.
...
-- Fewer submaps in localization mode (160 scans per submap vs 90 in mapping)
